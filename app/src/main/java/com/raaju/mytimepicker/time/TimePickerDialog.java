...
package com.raaju.mytimepicker.time;
...
import com.raaju.mytimepicker.customview.HapticFeedbackController;
import com.raaju.mytimepicker.R;
import com.raaju.mytimepicker.customview.TypefaceHelper;
import com.raaju.mytimepicker.customview.Utils;
import com.raaju.mytimepicker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
  ...
  public interface OnTimeSetListener {
     ...
     */
    void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, int hourOfDayEnd,
        int minuteEnd);
  }
  ...
  /**
   * Set whether the picker should dismiss itself when it's pausing or whether it should try to
      ...
      public void onClick(View v) {
        ...
        if (mCallback != null) {
          mCallback.onTimeSet(mTimePicker,
              mTimePicker.getHours(), mTimePicker.getMinutes(), mTimePickerEnd.getHours(),
              mTimePickerEnd.getMinutes());
        }
        dismiss();
      }
    });
